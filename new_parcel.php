            ...
            <div class="form-group">
              ...
              <input type="checkbox" name="type" id="dtype"
                  <?php echo isset($type) && $type == 1 ? 'checked' : '' ?>
                     data-bootstrap-switch data-toggle="toggle" data-on="Domicile" data-off="Agence" class="switch-toggle status_chk"
        ...
        <table class="table table-bordered" id="parcel-items">
          ...
          <tbody>
            <tr>
              ...
              <td><input type="number" class="text-right" name='price[]' value="<?php echo isset($price) ? $price :'' ?>" required></td>
              <?php if(!isset($id)): ?>
